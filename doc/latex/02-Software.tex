...
\begin{compactitem}
    ...
    \item LaTeX (optional, for documentation only)
  %  \item Doxygen (optional, for documentation only)
\end{compactitem}
...
\begin{compactdesc}
	\item [CSV] \ \\
	Comma separated values, used for population input data and simulator output. (default separator = ",")
	\item [TXT] \ \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Testing}
Unit tests are added to Stride based on Google's ``gtest" framework and in the rStride codebase.
...
\begin{compactdesc}
	...
	\item [stride\_log.txt] \ \\
	Details on the execution of the simulator (replaces the command line interface).
	\item [summary.csv] (optional) \ \\
	Aggregated results on the burden of disease, configuration details and timings.
