...
using IdPack_t =
    IDPack<Id::Household, Id::School, Id::Workplace, Id::CommunityWeekend, Id::CommunityWeekday, Id::HouseholdCluster, Id::Collectivity, Id::OtherHouse, Id::RestoCafe, Id::OtherPlace, Id::Transport>;
