...
exp_design <- expand.grid(r0                            = 2.5,
                          ...
                          telework_probability          = 0,         #TODO: remove with next update
                          ...
                          cnt_reduction_intergeneration = 0,          #TODO: remove with next update
                          cnt_reduction_intergeneration_cutoff = 0,   #TODO: remove with next update
