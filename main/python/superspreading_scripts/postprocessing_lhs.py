...
def main(output_dir, num_scenarios, num_parallel_workers):
    ...
    plot_contours(output_dir, "lhs_p80s_exclude_extinction", alpha_is, alpha_cs, mean_p80s_exclude_extinction, 0, 1)
    ...
    plot_contours(output_dir, "lhs_extinction_probabilities", alpha_is, alpha_cs, extinction_probabilities, 0, 1)
    ...
    plot_contours(output_dir, "lhs_ar_exclude_extinction", alpha_is, alpha_cs, mean_ars_exclude_extinction, 0.8, 1)
    ...
    plot_contours(output_dir, "lhs_peak_sizes", alpha_is, alpha_cs, mean_peak_sizes, 0, population_size)
    plot_contours(output_dir, "lhs_peak_sizes_exclude_extinction", alpha_is, alpha_cs, mean_peak_sizes_exclude_extinction, 0, population_size)
    ...
    plot_contours(output_dir, "lhs_day_of_peak", alpha_is, alpha_cs, mean_day_of_peak, 0, num_days)
    plot_contours(output_dir, "lhs_day_of_peak_exclude_extinction", alpha_is, alpha_cs, mean_day_of_peak_exclude_extinction, 0, num_days)
    ...
    plot_contours(output_dir, "lhs_hit_exclude_extinction", alpha_is, alpha_cs, mean_hits_exclude_extinction, 0, 1)
    ...
    plot_contours(output_dir, "lhs_hit_day_exclude_extinction", alpha_is, alpha_cs, mean_hits_day_exclude_extinction, 0, 200)
    ...
    plot_contours(output_dir, "lhs_day_of_last_infection", alpha_is, alpha_cs, mean_hits, 0, 200)
    plot_contours(output_dir, "lhs_day_of_last_infection_exclude_extinction", alpha_is, alpha_cs, mean_hits_exclude_extinction, 0, 200)

    plot_secondary_cases_per_index_case_means(output_dir, "lhs_secondary_cases_per_ic", all_secondary_cases_per_index_case, list(range(num_scenarios)), "blue")
